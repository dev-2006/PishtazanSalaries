...
{
    public class CsvInputProviderTests
    {
        [Fact]
        public void Convert_ValidInput_CreatesEmployeeSalaryObject()
        {
            CsvInputProvider inputProvider = new CsvInputProvider();
            EmployeeSalary salary = inputProvider.Convert("Ali,Ahmadi,1200000,400000,350000,14010801");
